...
{
    public class RotSymWaveApp : D3DApp
    {
        ...
        public RotSymWaveApp()
        {
            MainWindowCaption = "rotating symmetrical shaft";
        }
        ...
        public override void Initialize()
        {
            ...
            _grid = new Grid(grid_length, 0.25f, 0.02f);
