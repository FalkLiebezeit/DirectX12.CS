...
namespace DX12GameProgramming
{
    ...
    internal class WBoxApp : D3DApp
    {
        ...
        private float _phi = MathUtil.PiOverFour + 0.5f;
        ...
        public WBoxApp()
        {
            MainWindowCaption = "Wired Box  - Press ESC to Quit";
        }
        ...
        protected override void Update(GameTimer gt)
        {
            ...
            ObjectConstants cb = new ObjectConstants
            {
        ...
        protected override void Draw(GameTimer gt)
        {
            ...
            CommandList.SetVertexBuffer(0, _wboxGeo.VertexBufferView);
            CommandList.SetIndexBuffer(_wboxGeo.IndexBufferView);


            // https://learn.microsoft.com/en-us/windows/win32/direct3d11/d3d10-graphics-programming-guide-primitive-topologies

            //CommandList.PrimitiveTopology = PrimitiveTopology.TriangleList; // -> this line makes the simple box 
            CommandList.PrimitiveTopology = PrimitiveTopology.LineStrip;  // -> this line makes the wired box 
            ...
            CommandList.DrawIndexedInstanced(_wboxGeo.IndexCount, 1, 0, 0, 0);
        ...
        {
            Vector4 _color = Color.Blue.ToVector4();
...
*/
            ...
            Vertex[] vertices =
           {
                new Vertex { Pos = new Vector3(-1.0f, -1.0f, -1.0f), Color = _color },
                new Vertex { Pos = new Vector3(-1.0f, +1.0f, -1.0f), Color = _color},
                new Vertex { Pos = new Vector3(+1.0f, +1.0f, -1.0f), Color = _color },
                new Vertex { Pos = new Vector3(+1.0f, -1.0f, -1.0f), Color = _color },
                new Vertex { Pos = new Vector3(-1.0f, -1.0f, +1.0f), Color = _color},
			...
			VertexPositionColor m_objectVertices[] =
			{
				{ XMFLOAT3(-1.0f, -1.0f, -1.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //0
				{ XMFLOAT3(1.0f, -1.0f, -1.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //1
				{ XMFLOAT3(1.0f, -1.0f,  1.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //2
				{ XMFLOAT3(-1.0f, -1.0f,  1.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //3

				{ XMFLOAT3(-1.0f, 1.0f, -1.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //4
				{ XMFLOAT3(1.0f, 1.0f, -1.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //5
				{ XMFLOAT3(1.0f, 1.0f,  1.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //6
				{ XMFLOAT3(-1.0f, 1.0f,  1.0f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //7
			};

			unsigned short m_objectIndices[] =
			{
				0, 1, 1, 2, 2, 3, 3, 0,
            ...
            _wboxGeo = MeshGeometry.New(Device, CommandList, vertices, indices);
        }
