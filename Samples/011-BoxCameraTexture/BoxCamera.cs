...
namespace DX12GameProgramming
{
    ...
    public class BoxCameraApp : D3DApp
    {
        ...
        public BoxCameraApp()
        {
            MainWindowCaption = "textured Box in Camera";
        }
        ...
        public override void Initialize()
        {
            ...
            _camera.Position = new Vector3(0.0f, 2.0f, -15.0f);  // Camera Position
        ...
        private void BuildRenderItems()  // Build Render Items
        {
