...
namespace DX12GameProgramming
{
    public class CameraShapesApp : D3DApp
    {
        ...
        {
            MainWindowCaption = "CameraShapes - ESC to Quit";
        }
        ...
        public override void Initialize()
        {
            ...
            _camera.Position = new Vector3(0.0f, 2.0f, -20.0f);  // Camera Position
        ...
        private void OnKeyboardInput(GameTimer gt)  // On Keyboard Input Move
        {
        ...
        private void UpdateCamera(GameTimer gt)
        {
            ...
            _camera.X = _radius * MathHelper.Sinf(_phi) * MathHelper.Cosf(_theta * gt.TotalTime / 100.0f);
            _camera.Z = _radius * MathHelper.Sinf(_phi) * MathHelper.Sinf(_theta * gt.TotalTime / 100.0f);
            _camera.Y = _radius * MathHelper.Cosf(_phi);
