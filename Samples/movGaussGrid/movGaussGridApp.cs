...
{
    public class movGaussGridApp : D3DApp
    {
        ...
        private float _phi = MathUtil.PiOverTwo - 0.25f;
        ...
        public movGaussGridApp()
        {
            MainWindowCaption = "moving Gauss Grid";
        }
        ...
        public override void Initialize()
        {
            ...
            //            length in elements , length of element, timediff
            _grid = new Grid(100, 0.25f, 0.02f);
        ...
        private void UpdateGrid(GameTimer gt)
        {
            ...
            for (int i = 0; i < _grid.VertexCount; ++i)
            {
                var v = new Vertex
                {
                    ...
                    Color = Color.DarkGray.ToVector4()
                };
