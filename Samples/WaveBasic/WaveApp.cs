...
namespace DX12GameProgramming
{
    public class WaveApp : D3DApp
    {
        ...
        public override void Initialize()
        {
            ...
            _wave = new Wave(64, 64, 0.5f, 0.02f, 4.0f, 0.2f);
        ...
        private void UpdateWaves(GameTimer gt)
        {
            ...
            if (_once) 
            {
                ...
                float height = 3.0f; // MathHelper.Randf(0.0f, 4.0f);

                _wave.Disturb(32, 32, height);
            }

            // Update the wave simulation.
            _wave.Update(gt.DeltaTime * 5f);
            ...
            _waveRitem.Geo.VertexBufferGPU = currWavesVB.Resource;
        }
        ...
        {
            var indices = new short[3 * _wave.TriangleCount]; // 3 indices per face.
            Debug.Assert(_wave.VertexCount < 0x0000ffff);
            ...
            var geo = MeshGeometry.New(Device, CommandList, indices, "wave");

            geo.VertexByteStride = Utilities.SizeOf<Vertex>();
            geo.VertexBufferByteSize = geo.VertexByteStride * _wave.VertexCount;
        ...
        private void BuildFrameResources()
        {
            ...
            {
                _frameResources.Add(new FrameResource(Device, 1, _allRitems.Count, _wave.VertexCount));
        ...
        {
            _waveRitem = AddRenderItem(RenderLayer.Opaque, 0, "wave", "grid");
