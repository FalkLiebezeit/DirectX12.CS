...
{
    public class SphereMouseControlled : D3DApp
    {
        ...
        private float _phi      = 0.495f * MathUtil.Pi;
        ...
        public SphereMouseControlled()
        {
            MainWindowCaption = "simple Sphere mouse controlled - ESC to Quit";
        }
        ...
        protected override void Update(GameTimer gt)
        {
            ...
            float y = 3.5f * Math.Abs( MathHelper.Sinf(_phi * gt.TotalTime)) + 1.0f;

            Matrix sphereScale = Matrix.Scaling(1.0f);

            // Matrix sphereOffset = Matrix.Translation(0.0f, y , 0.0f);
            Matrix sphereOffset = Matrix.Translation(dx, y, dz);
            ...
            */
            ...
            _sphereRitem00.World = sphereScale * sphereOffset;
        ...
        private void BuildShapeGeometry()
        {
            ...
            SubmeshGeometry sphere = AppendMeshData(GeometryGenerator.CreateSphere(1.0f, 15, 10), Color.Crimson, vertices, indices);
        ...
        private void BuildRenderItems()
        {
            ...
            _sphereRitem00 = AddRenderItem(RenderLayer.Opaque, j++, "shapeGeo", "sphere",
                   world: Matrix.Translation(0.0f, 0.0f, 0.0f));

            //_sphereRitem01 = AddRenderItem(RenderLayer.Opaque, j++, "shapeGeo", "sphere",
            //       world: Matrix.Translation(0.0f, 0.0f, 0.0f));
