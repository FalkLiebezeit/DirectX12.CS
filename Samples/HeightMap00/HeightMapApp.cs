...
{
    public class HeightMapApp : D3DApp
    {
        ...
        private void UpdateWaves(GameTimer gt)
        {
            ...
            if ((Timer.TotalTime - _tBase) >= 0.25f)
            {
                ...
                float r = MathHelper.Randf(0.2f, 1.0f);
        ...
        private void BuildRenderItems()
        {
            ...
            /*
            _wavesRitem = AddRenderItem(RenderLayer.Opaque, 0, "landGeo", "grid");

            AddRenderItem(RenderLayer.Opaque, 1, "waterGeo", "grid");
            */
        ...
        /*
        private static float GetHillsHeight(float x, float z) => 0.15f * (z * MathHelper.Sinf(0.1f * x)) +
       

        private static float GetHillsHeight(float x, float z) => 15.0f * (MathHelper.Sinf(5.50f * x )) +
                                                                                (MathHelper.Cosf(5.50f * z ));
                                                                  (x * MathHelper.Cosf(0.1f * z));
        */
        private static float GetHillsHeight(float x, float z) => 0.005f * ((x * x) +
                                                                                (z * z));
