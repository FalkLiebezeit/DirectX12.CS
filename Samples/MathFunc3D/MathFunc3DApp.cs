...
{
    public class MathFunc3DApp : D3DApp
    {
        ...
        public MathFunc3DApp()
        {
            MainWindowCaption = "basic 3D Mathematical Function";
        }
        ...
        public override void Initialize()
        {
            ...
            _graph = new Graph(64, 64, 0.5f, 0.02f, 4.0f, 0.2f);
        ...
        private static float GetGraph(float x) => 1.3f * MathHelper.Sinf(1.5f * x * x);
        ...
        private void UpdateWaves(GameTimer gt)
        {
            ...
            if (_once) 
            {
                ...
                float height = 4.0f; // MathHelper.Randf(0.0f, 4.0f);

                _graph.Disturb(32, 32, height);
            }
