...
namespace DX12GameProgramming
{
    public class BoxesList : D3DApp
    {
        ...
        public BoxesList()
        {
            MainWindowCaption = "List of Boxes";
        }
        ...
        private void BuildRenderItems()
        {
            ...
            AddRenderItem(RenderLayer.Opaque, i++, "shapeGeo", "grid");


            AddRenderItem(RenderLayer.Opaque,i++, "shapeGeo", "box",
                world: Matrix.Scaling(2.0f, 2.0f, 2.0f) * Matrix.Translation(0.0f, 2.0f, -5.0f));
           
            
            AddRenderItem(RenderLayer.Opaque, i++, "shapeGeo", "box",
               world: Matrix.Scaling(2.0f, 2.0f, 2.0f) * Matrix.Translation(0.0f,  2.0f, 0.0f));
